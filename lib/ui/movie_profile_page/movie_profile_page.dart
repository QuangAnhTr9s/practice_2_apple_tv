...
class _MovieProfilePageState extends State<MovieProfilePage> {
                          ...
                          children: [
                            Row(
                              children: [
                                ...
                                Container(
                                  width: 60,
                                  decoration: BoxDecoration(border: Border.all(color: Colors.grey.shade400, width: 2,),
                                      borderRadius: BorderRadius.circular(5)),
                                  child: Center(
                                      child: Text('PC-16',
                                    style: TextStyle(fontWeight: FontWeight.bold, fontSize: 17, color: Colors.grey.shade400),
                                  )),
                                ),
                              ],
                            ),
                            ...
                            Text('${movie.yearOfManufacture} / ${movie.time}', style: TextStyle(fontSize: 16, color: Colors.grey.shade400),),
                            Text(movie.categories != null ? movie.categories!.join(', ') : '', style: TextStyle(fontSize: 16, color: Colors.grey.shade500),),
                            const SizedBox(height: 30,),
                            const Text('More Movies', style: TextStyle(color: Colors.white, fontSize: 19, fontWeight: FontWeight.bold),),
  ...
  InkWell buildButtonWatchNow(BuildContext context) {
    return InkWell(
                      onTap: () => ScaffoldMessenger.of(context)
                          .showSnackBar(const SnackBar(content: Center(child: Text('OK')),
                      )),
                      child: ClipRRect(
                        ...
                        // create container with color as a range of colors
                          ...
                          child: const Center(
                            ...
                            'Watch now',
                            style:
                                TextStyle(color: Color(0xFFCBCBCB), fontSize: 20),
                          )),
                        ),
                      ),
                    );
  ...
  Positioned buildListMoreMovies() {
    return Positioned(
            ...
            child: Builder(
              builder: (context) {
                final listMovieFeatured = _movieProfilePageBloc.createListMoreMovies(movie);
                return SizedBox(
                  height: 110,
                  width: MediaQuery.of(context).size.width,
