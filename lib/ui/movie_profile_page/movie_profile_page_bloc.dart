...
class MovieProfilePageBloc extends Bloc {
  ...
  Set<Movie> createListMoreMovies(Movie movie){
    return Bloc().listMovies.where((element)
    => movie.name != element.name && movie.yearOfManufacture -2 <= element.yearOfManufacture
        && element.yearOfManufacture <= movie.yearOfManufacture +2).toSet();
  }
